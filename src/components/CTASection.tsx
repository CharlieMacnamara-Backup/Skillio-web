      ...
      <Container className="relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
            <Link 
              href="#" 
              className="w-full sm:w-auto px-6 py-3.5 md:px-8 md:py-4 bg-white text-indigo-600 font-bold rounded-full shadow-xl hover:bg-zinc-50 transition-all hover:scale-105 active:scale-95 text-center"
            >
              {t("cta.appStore")}
            </Link>
            <Link 
              href="#" 
              className="w-full sm:w-auto px-6 py-3.5 md:px-8 md:py-4 bg-transparent text-white border-2 border-white/30 font-bold rounded-full hover:bg-white/10 transition-all text-center"
            >
              {t("cta.demo")}
            </Link>
          </div>
