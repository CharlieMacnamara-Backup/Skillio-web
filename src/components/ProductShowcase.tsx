            ...
            <div key={feature.key} className={`lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 lg:items-center ${feature.align === 'left' ? '' : 'lg:grid-flow-col-dense'}`}>
              ...
              <div className={`relative ${feature.align === 'left' ? 'lg:col-start-1' : 'lg:col-start-2'}`}>
                ...
                <div className="relative">
                  {/* Primary Image with Device Frame */}
                  <div className="mx-auto w-4/5 sm:w-2/3 md:w-1/2 lg:w-4/5 xl:w-2/3">
                    <DeviceScreenshot
                  ...
                  {feature.secondaryImages && feature.secondaryImages.length > 0 && (
                    <div className="absolute -bottom-6 -right-6 sm:-bottom-10 sm:-right-10 md:-bottom-12 md:-right-12 w-2/5 lg:w-1/2 xl:w-2/5 z-10 hidden sm:block">
                      <DeviceScreenshot
                  ...
                  {feature.secondaryImages && feature.secondaryImages.length > 1 && (
                    <div className="absolute -top-6 -left-6 sm:-top-10 sm:-left-10 md:-top-12 md:-left-12 w-2/5 lg:w-1/2 xl:w-2/5 z-10 hidden sm:block">
                      <DeviceScreenshot
